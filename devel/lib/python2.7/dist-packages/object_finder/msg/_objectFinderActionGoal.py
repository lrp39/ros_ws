...
class objectFinderActionGoal(genpy.Message):
  _md5sum = "4088afd7d46a8964bad7e3f48c8cd0f0"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_iB4f.pack(_x.goal.object_id, _x.goal.known_surface_ht, _x.goal.surface_ht, _x.goal.object_dimension1, _x.goal.object_dimension2, _x.goal.object_dimension3))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.object_id, _x.goal.known_surface_ht, _x.goal.surface_ht, _x.goal.object_dimension1, _x.goal.object_dimension2, _x.goal.object_dimension3,) = _struct_iB4f.unpack(str[start:end])
