...
"""autogenerated by genpy from velocity_action_server/velocityAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import velocity_action_server.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class velocityAction(genpy.Message):
  _md5sum = "7e5f74f47b7562a9a9216076cc2b493d"
  _type = "velocity_action_server/velocityAction"
...
"""
  ...
  _slot_types = ['velocity_action_server/velocityActionGoal','velocity_action_server/velocityActionResult','velocity_action_server/velocityActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(velocityAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = velocity_action_server.msg.velocityActionGoal()
      if self.action_result is None:
        self.action_result = velocity_action_server.msg.velocityActionResult()
      if self.action_feedback is None:
        self.action_feedback = velocity_action_server.msg.velocityActionFeedback()
    else:
      self.action_goal = velocity_action_server.msg.velocityActionGoal()
      self.action_result = velocity_action_server.msg.velocityActionResult()
      self.action_feedback = velocity_action_server.msg.velocityActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2di3I.pack(_x.action_goal.goal.amplitude.data, _x.action_goal.goal.frequency.data, _x.action_goal.goal.num_cycles, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.amplitude.data, _x.action_goal.goal.frequency.data, _x.action_goal.goal.num_cycles, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2di3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
