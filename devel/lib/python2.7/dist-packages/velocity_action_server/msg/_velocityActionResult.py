...
"""autogenerated by genpy from velocity_action_server/velocityActionResult.msg. Do not edit."""
import sys
...
class velocityActionResult(genpy.Message):
  _md5sum = "3fa2b15df3c07c71945669df816f357b"
  _type = "velocity_action_server/velocityActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','velocity_action_server/velocityResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(velocityActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = velocity_action_server.msg.velocityResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = velocity_action_server.msg.velocityResult()
