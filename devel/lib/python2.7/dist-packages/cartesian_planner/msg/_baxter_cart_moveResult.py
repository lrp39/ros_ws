...
"""autogenerated by genpy from cartesian_planner/baxter_cart_moveResult.msg. Do not edit."""
import sys
...
class baxter_cart_moveResult(genpy.Message):
  _md5sum = "411a8c6e3c32b53d24e0be87f505a1c1"
  _type = "cartesian_planner/baxter_cart_moveResult"
...
"""
  ...
  __slots__ = ['return_code','err_code','err_msg','computed_arrival_time','q_arm_right','q_arm_left','current_pose_gripper_right','current_pose_gripper_left','current_pose_flange_right','current_pose_flange_left']
  _slot_types = ['int32','int32','string','float64','float64[]','float64[]','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       return_code,err_code,err_msg,computed_arrival_time,q_arm_right,q_arm_left,current_pose_gripper_right,current_pose_gripper_left,current_pose_flange_right,current_pose_flange_left
    ...
    """
    if args or kwds:
      super(baxter_cart_moveResult, self).__init__(*args, **kwds)
      ...
      if self.current_pose_flange_right is None:
        self.current_pose_flange_right = geometry_msgs.msg.PoseStamped()
      if self.current_pose_flange_left is None:
        self.current_pose_flange_left = geometry_msgs.msg.PoseStamped()
    else:
      self.return_code = 0
      self.err_code = 0
      self.err_msg = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.current_pose_gripper_left.pose.position.x, _x.current_pose_gripper_left.pose.position.y, _x.current_pose_gripper_left.pose.position.z, _x.current_pose_gripper_left.pose.orientation.x, _x.current_pose_gripper_left.pose.orientation.y, _x.current_pose_gripper_left.pose.orientation.z, _x.current_pose_gripper_left.pose.orientation.w, _x.current_pose_flange_right.header.seq, _x.current_pose_flange_right.header.stamp.secs, _x.current_pose_flange_right.header.stamp.nsecs))
      _x = self.current_pose_flange_right.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.current_pose_flange_right.pose.position.x, _x.current_pose_flange_right.pose.position.y, _x.current_pose_flange_right.pose.position.z, _x.current_pose_flange_right.pose.orientation.x, _x.current_pose_flange_right.pose.orientation.y, _x.current_pose_flange_right.pose.orientation.z, _x.current_pose_flange_right.pose.orientation.w, _x.current_pose_flange_left.header.seq, _x.current_pose_flange_left.header.stamp.secs, _x.current_pose_flange_left.header.stamp.nsecs))
      _x = self.current_pose_flange_left.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.current_pose_flange_left.pose.position.x, _x.current_pose_flange_left.pose.position.y, _x.current_pose_flange_left.pose.position.z, _x.current_pose_flange_left.pose.orientation.x, _x.current_pose_flange_left.pose.orientation.y, _x.current_pose_flange_left.pose.orientation.z, _x.current_pose_flange_left.pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.current_pose_gripper_left.pose.position.x, _x.current_pose_gripper_left.pose.position.y, _x.current_pose_gripper_left.pose.position.z, _x.current_pose_gripper_left.pose.orientation.x, _x.current_pose_gripper_left.pose.orientation.y, _x.current_pose_gripper_left.pose.orientation.z, _x.current_pose_gripper_left.pose.orientation.w, _x.current_pose_flange_right.header.seq, _x.current_pose_flange_right.header.stamp.secs, _x.current_pose_flange_right.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.current_pose_flange_right.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.current_pose_flange_right.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.current_pose_flange_right.pose.position.x, _x.current_pose_flange_right.pose.position.y, _x.current_pose_flange_right.pose.position.z, _x.current_pose_flange_right.pose.orientation.x, _x.current_pose_flange_right.pose.orientation.y, _x.current_pose_flange_right.pose.orientation.z, _x.current_pose_flange_right.pose.orientation.w, _x.current_pose_flange_left.header.seq, _x.current_pose_flange_left.header.stamp.secs, _x.current_pose_flange_left.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.current_pose_flange_left.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.current_pose_flange_left.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 56
      (_x.current_pose_flange_left.pose.position.x, _x.current_pose_flange_left.pose.position.y, _x.current_pose_flange_left.pose.position.z, _x.current_pose_flange_left.pose.orientation.x, _x.current_pose_flange_left.pose.orientation.y, _x.current_pose_flange_left.pose.orientation.z, _x.current_pose_flange_left.pose.orientation.w,) = _struct_7d.unpack(str[start:end])
      return self
